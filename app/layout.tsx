...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        <link rel="canonical" href={process.env.NEXT_PUBLIC_SITE_URL || 'https://decodeit.vercel.app'} />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              '@type': 'WebApplication',
              name: 'DeCodeIt',
              description: 'Filter, search, and track LeetCode questions by company, difficulty, and frequency. Prepare for FAANG and top tech company interviews.',
              url: process.env.NEXT_PUBLIC_SITE_URL || 'https://decodeit.vercel.app',
              ...
              author: {
                '@type': 'Person',
                name: 'Yogesh Siwan',
                url: 'https://github.com/yogesiwan',
              },
              aggregateRating: {
              ...
              featureList: [
                'Company-specific LeetCode question filtering',
                'Multi-company analysis (union and intersection modes)',
                'Most frequent questions across all companies',
                'Time period filtering (30 days, 3 months, 6 months, all time)',
                'Difficulty and frequency filtering',
